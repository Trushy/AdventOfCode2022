...
int main(int ac, char **av)
{
    ...
    if (myfile.is_open())
    {
        while (getline(myfile, line))
        {
            ...
            if ((firstElfFirstInt >= secondElfFirstInt && firstElfFirstInt <= secondElfSecondInt) || (firstElfSecondInt >= secondElfFirstInt && firstElfSecondInt <= secondElfSecondInt))
                result++;
            else if ((secondElfFirstInt >= firstElfFirstInt && secondElfFirstInt <= firstElfSecondInt) || (secondElfSecondInt >= firstElfFirstInt && secondElfSecondInt <= firstElfSecondInt))
                result++;
        }
        myfile.close();
    }
